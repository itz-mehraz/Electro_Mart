...
const Banner = () => {
  ...
  const slides = [
    {
      imgSrc: bannerImgOne,
      text: "HP কালার প্রিন্টার",
      Subtext: "সেরা দামে কিনুন কালার প্রিন্টার😱",
      buttonLink: "/offer",
      buttonText: "Shop Now",
    },
    {
      ...
      Subtext: "আমাদের সকল প্রিন্টার এ পাচ্ছেন ১ বছরের সার্ভিস ওয়ারেন্টি.",
      buttonLink: "/shop",
      buttonText: "বিস্তারিত তথ্য!",
    },
    {
      imgSrc: bannerImgOne,
